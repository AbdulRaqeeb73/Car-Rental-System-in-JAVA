...
public class CarRegistration extends javax.swing.JFrame {
    ...
    try {
        ...
        String maxCarNo = rs.getString("Max(car_no)");

        if (maxCarNo == null || maxCarNo.length() <= 1) {  // Check for null or unexpected format
            jTextField1.setText("C0001");
        } else {
            // Make sure the string has enough characters to extract
            String idPart = maxCarNo.substring(1);  // Remove the "C" part
            try {
                long id = Long.parseLong(idPart);
                id++;
                jTextField1.setText("C0" + String.format("%03d", id));  // Format with leading zeros
